...
insert into stocks(stock_id, stock_name, description, ticker, stock_type, cost, currency) values (2, 'Kamaz', 'Russian automaker company', 'KMAZ', 'stock', 50, 1);
insert into stocks(stock_id, stock_name, description, ticker, stock_type, cost, currency) values (3, 'Facebook', 'US IT Company', 'FB', 'stock', 200, 2);
...
insert into stocks_items(stocks_item_id, portfolio, stock_item, stock_cost, stock_currency, amount) values (3, 1, 3, 200, 2, 30);
insert into stocks_items(stocks_item_id, portfolio, stock_item, stock_cost, stock_currency, amount) values (4, 1, 4, 1000, 2, 40);
insert into stocks_items(stocks_item_id, portfolio, stock_item, stock_cost, stock_currency, amount) values (5, 1, 5, 300, 3, 50);
insert into stocks_items(stocks_item_id, portfolio, stock_item, stock_cost, stock_currency, amount) values (6, 1, 6, 500, 3, 60);
insert into stocks_items(stocks_item_id, portfolio, stock_item, stock_cost, stock_currency, amount) values (7, 2, 1, 100, 1, 5);
insert into stocks_items(stocks_item_id, portfolio, stock_item, stock_cost, stock_currency, amount) values (8, 2, 2, 50, 1, 3);
insert into stocks_items(stocks_item_id, portfolio, stock_item, stock_cost, stock_currency, amount) values (9, 3, 1, 100, 1, 10);
insert into stocks_items(stocks_item_id, portfolio, stock_item, stock_cost, stock_currency, amount) values (10, 3, 2, 50, 1, 20);