...
insert into stocks_items(portfolio, stock_item, stock_cost, stock_currency, amount) values (4, 1, 100, 1, 10);
insert into stocks_items(portfolio, stock_item, stock_cost, stock_currency, amount) values (4, 2, 50, 1, 20);
insert into stocks_items(portfolio, stock_item, stock_cost, stock_currency, amount) values (4, 3, 200, 2, 30);
insert into stocks_items(portfolio, stock_item, stock_cost, stock_currency, amount) values (4, 4, 1000, 2, 40);
insert into stocks_items(portfolio, stock_item, stock_cost, stock_currency, amount) values (4, 5, 300, 3, 50);
insert into stocks_items(portfolio, stock_item, stock_cost, stock_currency, amount) values (4, 6, 500, 3, 60);
